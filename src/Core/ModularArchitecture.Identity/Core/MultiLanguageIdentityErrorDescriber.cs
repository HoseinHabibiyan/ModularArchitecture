...
namespace ModularArchitecture.Identity.Core
{
    public class MultiLanguageIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        { Code = nameof(PasswordMismatch), Description = _localizer["Incorrect password."] };
        ...
        public override IdentityError PasswordRequiresUniqueChars(int uniqueChars)
        {
            return new IdentityError
            {
                ...
                Description = string.Format(_localizer["Password required unique chars {0}."], uniqueChars)
            };
        }
        ...
        public override IdentityError RecoveryCodeRedemptionFailed()
        {
            ...
            {
                Code = nameof(PasswordRequiresUniqueChars),
                Description = _localizer["RecoveryCode redemption failed."]
            };
        }
    }
}
